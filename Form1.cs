...
namespace Yahtzeemk2
{
    ...
    public partial class Form1 : Form
    {
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je de score Three of a Kind wilt toevoegen?", "Controleer", MessageBoxButtons.YesNo);
            ...
            {
                MessageBox.Show("Kies een andere optie");
                return;
            }
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je de score or Use Four of a kind wilt toevoegen", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                fourkcnt += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je de score the Full House  wilt toevoegen?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                fullhousecount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je de score the Small Straight wilt toevoegen?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                smllstraightcount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je de score the Large Straight wilt toevoegen?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                lrgstraightcount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je de score the Extra Score wilt toevoegen?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                othcount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je de score yahtzee wilt toevoegen?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                yzcount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je ONE wilt toevoegen aan je punten?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                fvonecount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je TWO wilt toevoegen aan je punten?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                fvtwocount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je THREE wilt toevoegen aan je punten?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                fvthreecount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je FOUR wilt toevoegen aan je punten?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                fvfourcount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je FIVE wilt toevoegen aan je punten?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                fvfivecount += 1;
                button12_Click(sender, e);
        ...
        {
            DialogResult res = MessageBox.Show("Weet je zeker dat je SIX wilt toevoegen aan je punten?", "Controleer", MessageBoxButtons.YesNo);
            if (res == DialogResult.Yes)
            {
                fvsixcount += 1;
                button12_Click(sender, e);
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("scrum groep 9", "Makers");
            }
        ...
        {
            System.Diagnostics.Process.Start(Application.ExecutablePath); //Het opnieuw opstarten van de 
            this.Close(); //Applicatie sluiten
        }
        ...
        {
            // Het rollen van de dobbelsteen
            //TODO Images toevoegen als dobelsteens
            if (holdcount1 < 1)
            {
                int francis1 = frank.Pop();
                textBox1.Text = francis1.ToString();
        ...
        {
            MessageBox.Show("-_-_-_-_-_-", "Maker");
        }
        ...
        private void whoIsTheCreatorToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("scrum groep 9", "Maker");
        }
